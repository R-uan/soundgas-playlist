  ...
  return (
    <div className="flex flex-row left-0 absolute bottom-0 justify-center w-screen h-[76px] bg-[#0D0F12] z-50">   
      <div className="flex flex-row p-3 gap-10 items-center">
          <audio ref={audioPlayerRef} onPlay={() => setPlaying(true)} src={currentAudio ? currentAudio : ""} onEnded={handleOnAudioEnd} onTimeUpdate={handleTimeUpdate} onLoadedMetadata={handleLoadMetaData} autoPlay></audio>
          {/* Current Audio Info */}
          <div className="flex flex-col h-fit w-[440px]">
            ...
            <div className="relative">
              <span className="absolute right-0 bottom-full">{currentTime} / {totalDuration}</span>
              <div>
